export const templateHtml = (name: string, date: string) => {
  return `
...
<!--[if !mso]><!--><link href="https://fonts.googleapis.com/css2?family=Anton&display=swap" rel="stylesheet" type="text/css"><link href="https://fonts.googleapis.com/css?family=Montserrat:400,700&display=swap" rel="stylesheet" type="text/css"><!--<![endif]-->
...
<div class="u-row-container" style="padding: 0px;background-image: url('https://jevtuwchndehjsmaflia.supabase.co/storage/v1/object/public/anx-bucket/public/image-7.png');background-repeat: no-repeat;background-position: center top;background-color: #fdeed2">
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 25px; font-weight: 700;"><span>Welcome ${name}!</span></h1>
...
<table id="u_content_heading_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-font-size" style="margin: 0px; line-height: 110%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 50px; font-weight: 700;"><span>New Member<br /></span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%; margin: 0px;"><span style="font-family: Anton; line-height: 22.4px; font-size: 16px; color: #3a3a3a;">Dear ${name}, welcome to our platform. Keep setting up your</span></p>
<p style="line-height: 140%; margin: 0px;"><span style="font-family: Anton; line-height: 22.4px; font-size: 16px; color: #bbbbbb;"><span style="color: #3a3a3a; line-height: 22.4px;">profile to unlock all the features availables in the app.</span>&nbsp;</span></p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://jevtuwchndehjsmaflia.supabase.co/storage/v1/object/public/anx-bucket/public/image-2.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 580px;" width="580" class="v-src-width v-src-max-width"/>
...
<p style="font-size: 14px; line-height: 170%; margin: 0px;">Copyright ${date} Breadriuss</p>
  </div>
